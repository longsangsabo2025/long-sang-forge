...
export class SitemapGenerator {
  ...
  async addBlogPosts(supabaseClient: any) {
    try {
  ...
  async addTournaments(supabaseClient: any) {
    try {
  ...
  // Add agent pages
  async addAgents(supabaseClient: any) {
    try {
...
export async function updateSitemap(supabaseClient: any, baseUrl: string) {
  try {
