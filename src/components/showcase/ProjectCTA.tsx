        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          {project.production_url && (
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-2 px-8 py-4 bg-primary hover:bg-primary/90 text-primary-foreground font-bold rounded-xl transition-colors shadow-lg"
            >
