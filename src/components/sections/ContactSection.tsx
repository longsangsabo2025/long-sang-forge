...
import { Linkedin, Github, Twitter, Mail, MapPin, Globe, CheckCircle, AlertCircle, Calendar } from "lucide-react";
...
export const ContactSection = () => {
  ...
  const contactSchema = z.object({
    ...
    message: z.string().trim().min(20, t('contact.validation.messageMin')).max(1000, t('contact.validation.messageMax')),
        ...
        <div className="grid lg:grid-cols-[1.5fr_1fr] gap-12 lg:gap-16">
          ...
          <div className="bg-card border border-border/10 rounded-2xl p-8 md:p-10 shadow-[0_4px_24px_rgba(0,0,0,0.2)]">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Service Dropdown */}
              <div>
                <Label htmlFor="service" className="text-sm font-medium text-muted-foreground mb-2 block">
                ...
                >
                  ...
                  <SelectContent className="bg-card border-border/10 z-50">
                    <SelectItem value="mobile">{t('contact.form.serviceOptions.mobile')}</SelectItem>
                    ...
                    <SelectItem value="not-sure">{t('contact.form.serviceOptions.notSure')}</SelectItem>
                  </SelectContent>
                </Select>
                {errors.service && (
              ...
              {/* Budget Dropdown */}
              <div>
                <Label htmlFor="budget" className="text-sm font-medium text-muted-foreground mb-2 block">
                ...
                >
                  ...
                  <SelectContent className="bg-card border-border/10 z-50">
                    <SelectItem value="under-5k">{t('contact.form.budgetOptions.under5k')}</SelectItem>
                    <SelectItem value="5k-15k">{t('contact.form.budgetOptions.5k15k')}</SelectItem>
                    <SelectItem value="15k-50k">{t('contact.form.budgetOptions.15k50k')}</SelectItem>
                    <SelectItem value="50k-plus">{t('contact.form.budgetOptions.50kPlus')}</SelectItem>
                    <SelectItem value="not-sure">{t('contact.form.budgetOptions.notSure')}</SelectItem>
                  </SelectContent>
                </Select>
              </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4 mt-8">
              ...
              <div className="bg-card border border-border/10 rounded-xl p-6 hover:-translate-y-1 hover:border-primary/40 hover:shadow-[0_12px_24px_rgba(0,0,0,0.2)] transition-all duration-300">
                <p className="text-sm font-bold text-foreground mb-2">{t('contact.consultations.free.badge')}</p>
                <h3 className="text-lg font-semibold text-foreground mb-2">
                  {t('contact.consultations.free.title')}
                </h3>
                <p className="text-sm text-muted-foreground mb-1">{t('contact.consultations.free.duration')}</p>
              ...
              <div className="bg-card border border-border/10 rounded-xl p-6 hover:-translate-y-1 hover:border-primary/40 hover:shadow-[0_12px_24px_rgba(0,0,0,0.2)] transition-all duration-300">
                <p className="text-sm font-bold text-foreground mb-2">{t('contact.consultations.paid.badge')}</p>
                <h3 className="text-lg font-semibold text-foreground mb-2">
                  {t('contact.consultations.paid.title')}
                </h3>
                <p className="text-sm text-muted-foreground mb-1">{t('contact.consultations.paid.duration')}</p>
