...
import { AlertCircle, TrendingUp, TrendingDown, Target, Globe, BarChart3, Zap } from 'lucide-react';
...
export const SEOMonitoringDashboard: React.FC = () => {
  ...
  const [dashboardData, setDashboardData] = useState({
    ...
    pages: [
      ...
      { url: 'longsang.org/arena/tournaments', title: 'Gaming Tournaments', score: 88, traffic: 800 },
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{dashboardData.summary.totalTraffic.toLocaleString()}</div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">{dashboardData.summary.criticalIssues} nghiêm trọng</p>
          </CardContent>
        </Card>
      </div>
              ...
              <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">{issue.count} trang bị ảnh hưởng</div>
                  </div>
                </div>
