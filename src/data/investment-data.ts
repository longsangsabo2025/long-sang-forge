...
export const investmentData: InvestmentData[] = [
  // SABO Arena - Billiards Competition App
  {
    ...
    foundation: {
      vision:
        "Trở thành nền tảng thi đấu bi-a uy tín tại Việt Nam, kết nối người chơi và câu lạc bộ trong hệ sinh thái thể thao điện tử.",
      mission:
        "Số hóa và chuyên nghiệp hóa môn thể thao bi-a thông qua công nghệ AI, tạo ra trải nghiệm thi đấu công bằng, minh bạch và hấp dẫn cho mọi người.",
      problemStatement:
        "Thị trường bi-a Việt Nam trị giá $200M/năm nhưng vẫn thiếu một nền tảng số để quản lý giải đấu, xếp hạng cầu thủ và kết nối cộng đồng. 80% giải đấu vẫn dùng giấy tờ, dẫn đến tranh chấp kết quả và thiếu minh bạch.",
      marketOpportunity:
        "Vietnam có 50,000+ câu lạc bộ bi-a với 5M+ người chơi thường xuyên. Thị trường esports đang bùng nổ với CAGR 25%. SABO Arena là cầu nối giữa bi-a truyền thống và thể thao điện tử, TAM ước tính $500M trong 5 năm.",
    ...
    risks: [
      {
        ...
        description:
          "Adoption rate có thể chậm hơn dự kiến do cộng đồng bi-a truyền thống chưa quen công nghệ",
        impact: "medium",
      ...
      },
      {
        ...
        impact: "low",
        mitigation:
          "99.8% accuracy đã proven qua 100K+ matches. Continuous training với real data.",
      },
      {
