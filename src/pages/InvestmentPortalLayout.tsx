/**
 * Investment Portal Layout
 * ========================
 * VIP-only feature for project investment
 *
 * ELON AUDIT: Gate behind VIP subscription (investment_access)
 */

import { FeatureGate } from "@/components/subscription/FeatureGate";
import { projectsData } from "@/data/projects-data";
import { motion } from "framer-motion";
import { ArrowLeft, BarChart3, FileText, Map, TrendingUp } from "lucide-react";
...
const InvestmentPortalLayout = () => {
  ...
  return (
    <FeatureGate feature="investment_access" showUpgrade={true}>
