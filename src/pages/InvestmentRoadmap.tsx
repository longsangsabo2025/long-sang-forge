                    ...
                    <GlowCard className="p-8 hover:scale-105 transition-transform duration-300">
                      ...
                      <div className="flex items-start justify-between mb-6">
                        <div className="flex items-center gap-4">
                          <div
                            className={`p-4 rounded-xl bg-gradient-to-r from-${phase.color}-500/20 to-${phase.color}-600/20`}
                          >
                    ...
                    <div
                      ...
                      ${
                        phase.status === "completed"
                          ...
                          : phase.status === "in-progress"
                          ? "bg-yellow-500 shadow-[0_0_30px_rgba(234,179,8,0.5)] animate-pulse"
      ...
      >
        <GlowCard className="p-12 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Tôi cập nhật tiến độ hàng quý với báo cáo chi tiết cho nhà đầu tư. Tất cả milestones đều
            được tracking công khai và minh bạch.
          </p>
        </GlowCard>
      </motion.div>
    </div>
