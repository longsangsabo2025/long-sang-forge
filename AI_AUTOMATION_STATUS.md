...
http://localhost:8084/automation

# 2. Admin Management (Configuration)
http://localhost:8084/agent-center

# 3. Developer Testing (Debug)
http://localhost:8084/admin/workflows
```
...
### Test User Dashboard:
```bash
1. Open http://localhost:8084/automation
...
```bash
1. Open http://localhost:8084/agent-center
...
```bash
1. Open http://localhost:8084/admin/workflows
