...
4. **AgentStatusCards** - Tooltip cho các status badges
5. **ContentQueueList** - Tooltip cho priority levels
6. **ActivityLogList** - Tooltip cho status icons
7. **AgentDetail** - Inline help text trong config section
